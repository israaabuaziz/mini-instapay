    ...
    public class TransactionController : ControllerBase
    {
        ...
        public async Task<IActionResult> sendMoney([FromForm]CreateTrans modelreq)
        {
            ...
            var receiverResponse = await httpClientUser
                .GetAsync($"http://project-1.runasp.net/api/User/{modelreq.receiverPhone}");
            ...
            var updateResponse = await httpClientUser
                .PutAsJsonAsync($"http://project-1.runasp.net/api/User/{receiverId}", updatePayload);
            ...
            var debitResponse = await httpClientUser.PutAsJsonAsync($"http://project-1.runasp.net/api/User/{modelreq.sender}", debitPayload);
            ...
            var response = await httpClientUser.PostAsJsonAsync($"http://project-3.runasp.net/api/Report", payload);
